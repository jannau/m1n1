...
SwapInfoBlob = Struct(
    "unk" / Bytes(0x6c4),
    Ver("V >= V13_3", "unk_13_3" / Bytes(0x10)),
)
...
IOMFBSwapRec = Struct(
    ...
    Ver("V < V13_3", "unk_2e2" / UnkBytes(0x2)),
    Ver("V >= V13_3", "unk_2e2" / UnkBytes(0x3)),
    ...
    Ver("V >= V13_3", "unk_320" / UnkBytes(0x147)),
)
...
IOSurface = Struct(
    ...
    "unk_1f9" / Int32ul,
    "padding" / UnkBytes(7),
    Ver("V >= V13_3", "padding_13_3" / UnkBytes(40)),
)
